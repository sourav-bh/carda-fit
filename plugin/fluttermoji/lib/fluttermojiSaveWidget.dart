  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        var newAvatar = fluttermojiController.getFluttermojiFromOptions();

        var newFlutterMojiMap =
            jsonEncode(fluttermojiController.selectedOptions);
        if (onTap != null) onTap!(newAvatar, newFlutterMojiMap);
      },
