...
class _LeaderBoardPageState extends State<LeaderBoardPage> {
  ...
  Future<bool> _checkIfUserHasAvatar() async {
    return SharedPref.instance.hasValue(SharedPref.keyUserAvatar);
  }

  _saveAction() async {
    String avatar = _avatarText.text;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<bool>(
        future: _checkIfUserHasAvatar(), // async work
                ...
                return Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Du hast den 4. Platz erreicht!',
                        style: Theme.of(context).textTheme.caption?.copyWith(color: AppColor.darkBlue, fontSize: 30, fontStyle: FontStyle.normal,),
                        textAlign: TextAlign.center,
                      ),
                    ),
                    Text('Mit 195 Punkte', style: Theme.of(context).textTheme.bodyText2?.copyWith(fontSize: 20, color: Colors.brown)),
                            ...
                            child: CustomPaint(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Cyan', style: Theme.of(context).textTheme.headline6?.copyWith(fontWeight: FontWeight.w600, fontSize: 24), textAlign: TextAlign.center,),
